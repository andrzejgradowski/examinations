...
class ProposalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create proposal" do
    assert_difference('Proposal.count') do
      post proposals_url, params: { proposal: { given_names: @proposal.given_names, name: @proposal.name, user_id: @proposal.user_id } }
    end
  ...
  test "should update proposal" do
    patch proposal_url(@proposal), params: { proposal: { given_names: @proposal.given_names, name: @proposal.name, user_id: @proposal.user_id } }
